    ...
    <section id="community" className="section">
      <div className="container">
        ...
        <div className="community-header-wrapper" style={{ marginBottom: '2.5rem' }}>
          <div className="community-subtitle" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem', color: 'var(--primary)' }}>
            <TrendingUp size={20} />
            <span style={{ fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', fontSize: '0.8rem' }}>Global Ecosystem</span>
          </div>
          <h3 className="community-title" style={{ fontSize: 'clamp(2.2rem, 5vw, 3.2rem)', marginBottom: '0.5rem', fontFamily: 'Space Grotesk', fontWeight: 800 }}>
