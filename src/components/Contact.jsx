    ...
    <section id="contact" className="section" style={{ paddingBottom: '10rem' }}>
      <div className="glass-panel" style={{ textAlign: 'center', padding: '4rem 2rem', background: 'linear-gradient(180deg, rgba(30,41,59,0.7) 0%, rgba(170,221,81,0.05) 100%)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '2rem', flexWrap: 'wrap' }}>
          <a href="https://linkedin.com/in/tunguyendata" target="_blank" rel="noreferrer" className="glass-panel" style={{ textDecoration: 'none', flex: '1 1 220px', minWidth: 0, padding: '1.5rem', border: '1px solid rgba(123, 208, 255, 0.2)' }}>
          ...
          <a href="https://github.com/tunguyenn99" target="_blank" rel="noreferrer" className="glass-panel" style={{ textDecoration: 'none', flex: '1 1 220px', minWidth: 0, padding: '1.5rem', border: '1px solid rgba(170, 221, 81, 0.2)' }}>
          ...
          <a href="https://www.facebook.com/groups/xomdata" target="_blank" rel="noreferrer" className="glass-panel" style={{ textDecoration: 'none', flex: '1 1 220px', minWidth: 0, padding: '1.5rem', border: '1px solid rgba(245, 158, 11, 0.2)' }}>
